  ...
  return (
    <a
      className={`
        ...
        transition-transform duration-200 hover:-translate-y-0.5 dark:border-bd-dark
        dark:bg-[#343642] dark:text-main-dark
      `}
      href={techItem.url}
    >
      <img
        className={`mr-1 h-5 w-5 ${techItem.imgClass ? techItem.imgClass : ''}`}
        src={techItem.icon}
        alt={techItem.name}
        width="20"
        height="20"
