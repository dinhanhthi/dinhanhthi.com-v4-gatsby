...
export const author = {
  ...
  intro:
    'I am a Vietnamese with a curious mind. I would like to learn something new every day. I also have a PhD in Applied Mathematics and currently work as a <span>Data Scientist</span>. On this page, you can find the notes I made when I discovered something new in the fields of <span>Data Science</span> and <span>Web Development</span>.',
  lookForJob: false,
}
